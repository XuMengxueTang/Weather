...
private EditText cityid;
    ...
    protected void onCreate(Bundle mSearch) {
        super.onCreate(mSearch);
        setContentView(R.layout.activity_search);
        initView();
        cityid = (EditText) this.findViewById(R.id.et_search_text);
        ImageView tosearch = (ImageView) findViewById(R.id.tosearch_button);
        tosearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(true){
                    String citycode = cityid.getText().toString().trim();
                    Log.d("fan", "--citycode---" + citycode);
